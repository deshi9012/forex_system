		...
		<form class="form">
			<div class="form__main">
				...
				<div class="form__triple">
					...
					<div class="form-group form-md-line-input" v-bind:class="{'has-error': error.description}" @click="removeError('description')">
        ...
        methods: {
         getCategories(){
        	...
        	savePage(){
				...
				self.page.categories = $('#categories').val();
				axios.post('/page', this.page).then(
					function (response) {
